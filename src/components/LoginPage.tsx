...
export function LoginPage({ onLogin, onSignup, onMagicLink, loading = false, error = null }: LoginPageProps) {
  ...
  const validatePw = () => {
    ...
    if (!emailValid) return 'Use a @bacardi.com email'
  ...
  const handlePassword = async (e: React.FormEvent) => {
    ...
    if (mode === 'login') {
      ...
      if (res?.status === 'check-email') {
        ...
        setInfo('Account created! Check your inbox (and spam) to confirm, then sign in.')
      }
    }
  }
          ...
          {!usePassword ? (
            ...
            magicSent ? (
              ...
              <form onSubmit={handleMagic} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="nome@bacardi.com" autoComplete="email"
                ...
                <button
                  type="button" onClick={() => { setUsePassword(true); clearMessages() }}
            ...
            <>
              ...
              <form onSubmit={handlePassword} className="space-y-4">
                ...
                <button
                  type="button" onClick={() => { setUsePassword(false); clearMessages() }}
                  className="w-full text-center text-slate-500 hover:text-slate-300 text-xs transition-colors"
                >
